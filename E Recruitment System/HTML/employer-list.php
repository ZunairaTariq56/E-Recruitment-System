            ...
            <div class="col-lg-8 col-md-12">
                ...
                <div class="employer-box">
                    ...
                    <div class="employer-info">
                        <h5><a href="#">The Kings</a></h5>
                        <div class="employer-meta">
                            <i class="flaticon-pin"></i>New York City<a href="#" class="open-position">4 Open Position</a>
                        </div>
                ...
                <div class="employer-box">
                    ...
                    <div class="employer-info">
                        <h5><a href="#">Red Kings</a></h5>
                        <div class="employer-meta">
                            <i class="flaticon-pin"></i>New York City<a href="#" class="open-position">7 Open Position</a>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus tincidunt aliquam. Aliquam gravida massa at sem vulputate interdum.</p>
                    </div>
                </div>
                <div class="employer-box">
                    ...
                    <div class="employer-info">
                        <h5><a href="#">Green Real Estate</a></h5>
                        <div class="employer-meta">
                            <i class="flaticon-pin"></i>New York City<a href="#" class="open-position">9 Open Position</a>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus tincidunt aliquam. Aliquam gravida massa at sem vulputate interdum.</p>
                    </div>
                </div>
                <div class="employer-box">
                    ...
                    <div class="employer-info">
                        <h5><a href="#">24 Company Logo</a></h5>
                        <div class="employer-meta">
                            <i class="flaticon-pin"></i>New York City<a href="#" class="open-position">2 Open Position</a>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus tincidunt aliquam. Aliquam gravida massa at sem vulputate interdum.</p>
                    </div>
                </div>
                <div class="employer-box">
                    ...
                    <div class="employer-info">
                        <h5><a href="#">Abc Logo</a></h5>
                        <div class="employer-meta">
                            <i class="flaticon-pin"></i>New York City<a href="#" class="open-position">6 Open Position</a>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus tincidunt aliquam. Aliquam gravida massa at sem vulputate interdum.</p>
                    </div>
                </div>
                ...
                <div class="pagination-box hidden-mb-45 text-center">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="page-link" href="grid-sidebar.html">Prev</a>
                            </li>
