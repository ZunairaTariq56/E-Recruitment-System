...
$faculty = $_GET['total_faculty'];
$coures = $_GET['course_name'];
$total_course = $_GET['total_course'];
if($faculty != 0){
  $data = $total_course/2;
  $data1 = round($data - $faculty);
  if($data1 < 0){
      $result = "Need NO more Faculty members!";
  }else{
  $result = "Need $data1 more Faculty members!";}
}
else{
  $data = $total_course/2;
  $data1 = round($data - $faculty);
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-pad">
                <div class="content-area5 dashboard-content">
                    <div class="dashboard-header clearfix">
                        ...
                        <h1 style="padding-left:200px;padding-top:150px;padding-bottom:150px;"><?php echo $result; ?></h1>
