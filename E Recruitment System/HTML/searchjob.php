    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 col-md-12">
                ...
                if(isset($_GET['find_job']))
                {
                  $jb_title = $_GET['search'];
                  $loc = $_GET['location'];
                  $sql = "SELECT * FROM job_post where job_title like '$jb_title%' AND location like '$loc'";
                ...
                <div class="job-box">
                    <div class="company-logo">
                        <img src="<?php echo $file; ?> " alt="logo" width="140px"height="70px">
                    </div>
                    <div class="description">
                        <div class="float-left">
                            <h5 class="title"><a href="job-details.php?jb_id=<?php echo $id; ?>"><?php echo $post_title;?></a></h5>
