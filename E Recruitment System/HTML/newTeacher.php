...
if(isset($_POST['findFaculty'])){
$coures = $_POST['coures'];
$sql = "SELECT * FROM faculty where designation = '$coures'";
$query = mysqli_query($con,$sql);
if(mysqli_num_rows($query) > 0){
  $faculty = mysqli_num_rows($query);
}
else{
  $faculty = 0;
}
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-pad">
                <div class="content-area5 dashboard-content">
                    ...
                    <div class="submit-address dashboard-list">
                        <form action="newTeacher.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                      <div class="col-lg-12 col-md-6 col-sm-12">
                                          <div class="form-group">
                                              ...
                                              <select class="selectpicker search-fields" name="coures" id="form_cname" autocomplete="off">
                                                ...
                                                <span id="cname_error_message" class="error_form text-danger"> </span>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-lg-6">
                                          <div class="post-btn"><button name="findFaculty" class="btn btn-md button-theme">Check Faculty</button></div>
                                      </div>
                        ...
                        <form action="newfaculty.php" method="GET" enctype="multipart/form-data" onsubmit="return validation()">
                            <h4 class="bg-grea-3">Basic Information</h4>
                            <div class="search-contents-sidebar">
                                <div class="row pad-20">
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                      <div class="col-lg-12 col-md-6 col-sm-12">
                                          <div class="form-group">
                                              <label>Coure Name</label>
                                                  <input type="text" class="input-text" name="course_name" value="<?php echo $coures; ?>" id="form_tcourse" required="">
                                                <span id="cname_error_message" class="error_form text-danger"> </span>
                                          </div>
                                      </div>
                                      <div class="col-lg-12 col-md-6 col-sm-12">
                                          <div class="form-group">
                                              <label>Faculty</label>
                                                  <input type="text" class="input-text" name="total_faculty" value="<?php echo $faculty; ?>" id="form_tcourse" required="">
                                                <span id="cname_error_message" class="error_form text-danger"> </span>
                                          </div>
                                      </div>
                                      <div class="col-lg-12 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="input-text" name="total_course" placeholder="Total Course" id="form_tcourse" required="">
                                            <span id="tcourse_error_message" class="error_form text-danger"> </span>
                                        </div>
                                      </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="post-btn"><button name="new_faculty" class="btn btn-md button-theme">New Faculty</button></div>
                                    </div>
                                </div>
                            </div>
