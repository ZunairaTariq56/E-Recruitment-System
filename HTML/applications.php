...
<div class="candidate-listing-section content-area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                ...
                $jobId = $_GET['jb_id'];
                $sql = "SELECT * FROM job_apply where j_id = '$jobId'";
                        ...
                        <div class="f-left">
                            ...
                            <div class="candidate-listing-footer">
                                <ul>
                                    ...
                                    <li><i class="flaticon-pin"></i><?php echo $country; ?> | <?php echo $city; ?></li>
                                </ul>
                            </div>
                        </div>
   ...
   ?> <h2 style="padding-left:350px; color:red;" >This job is not applied yet! </h2><?php
}
               ?>
            </div>
        </div>
